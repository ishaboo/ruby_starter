# Characters
Character.create(name: "Mygdin", race: "Elf", discipline: "thief", hitpoints: 28, strength: 7, exp: 0, x_coord: 1, y_coord: -2, alive: true)
Character.create(name: "Govin", race: "Elf", hitpoints: 26, strength: 6, exp: 0, x_coord: 0, y_coord: 0, alive: true)
Character.create(name: "Donder", race: "Human", hitpoints: 22, strength: 9, exp: 0, x_coord: 0, y_coord: 0, alive: true)
Character.create(name: "Glimli", race: "Dwarf", discipline: "warrior", hitpoints: 30, strength: 11, exp: 0, x_coord: 0, y_coord: 0, alive: true)
Character.create(name: "Ormir", race: "Orc", hitpoints: 32, strength: 12, exp: 0, x_coord: 0, y_coord: 0, alive: true)
